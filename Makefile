.PHONY: test lint smoke smoke-link smoke-replay smoke-duplicate smoke-timeout smoke-disable smoke-reset uvm clean
...
smoke: smoke-link smoke-replay smoke-duplicate smoke-timeout smoke-disable smoke-reset
